...
def index(request):
    ...
    try:
        ...
        genre_url = f"https://api.themoviedb.org/3/genre/movie/list?api_key={api_key}&language=es-ES"
...
def your_ajax_view(request):
    ...
    genre_movies_url = f"https://api.themoviedb.org/3/discover/movie?api_key={api_key}&language=es-ES&with_genres={genre}"
